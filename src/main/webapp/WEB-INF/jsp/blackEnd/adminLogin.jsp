...
<link rel="stylesheet" type="text/css" href="css/bootstrap.minAdmin.css" />
...
<div class="login_div">
	...
	<form action="doAdminUserLogin.html" class="login" method="post">
		<div class="nav">
			<div class="nav login_nav">
				...
				<div class="col-xs-6 login_usernameInput">
					<input type="text" name="adminUserName" id="name" value="" placeholder="&nbsp;&nbsp;用户名/手机号"  onblur="javascript:ok_or_errorBylogin(this)" />
				</div>
			...
			<div class="nav login_psdNav">
				...
				<div class="col-xs-6">
					<input type="password" name="adminUserPassword" id="psd" value="" placeholder="&nbsp;&nbsp;密码" onBlur="javascript:ok_or_errorBylogin(this)" />
				</div>
				<div class="col-xs-1 ok_gou">
					√
				</div>
